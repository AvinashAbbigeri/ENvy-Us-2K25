    ...
    return (
        <div className='flex flex-row items-center justify-between lg:mt-[0px] mt-[120px]'>
            <div className='z-50 flex flex-col ml-[20px] xl:ml-[200px] md:ml-10 gap-1 h-[80vh] md:h-fit'>
                ...
                <Link to="/events" className='lg:text-[26px] md:text-[20px] text-[14px] text-[#F5C98A] bg-[#023047] w-max px-3 py-1 rounded-md mt-4 '>View Events</Link>
                <Link to="/venue" className='lg:text-[26px] md:text-[20px] text-[14px] text-[#F5C98A] bg-[#023047] w-max px-3 py-1 rounded-md mt-4 '>Venue List</Link>
            </div>
